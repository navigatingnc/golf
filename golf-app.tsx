              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gray-200">
                  {members.map(member => {
                    ...
                    const avgScore = memberRounds.length > 0 
                      ? Math.round(memberRounds.reduce((sum, r) => sum + r.score, 0) / memberRounds.length)
                      : 'N/A';
                    ...
                    return (
                      <tr key={member.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4">
                          <span className="font-semibold text-blue-600">{member.handicap}</span>
                        </td>
                        <td className="px-6 py-4">{memberRounds.length}</td>
                        <td className="px-6 py-4">{avgScore}</td>
                      </tr>
                    );
                  })}
                </tbody>
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">
                              {rounds.filter(r => r.memberId === member.id && r.status === 'completed').length} rounds played
                            </div>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-2xl font-bold text-blue-600">{member.handicap}</div>
